export default [
  ...
  { name:'智能分析（异步）', path: '/add_chart_async', icon: 'Sliders', component: './AddChartAsync'},
  { name:'智能分析（消息队列）', path: '/add_chart_async_mq', icon: 'FundFilled', component: './AddChartAsyncMq'},
